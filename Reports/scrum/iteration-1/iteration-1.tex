...
\label{cpt:iteration1}
	...
	\section{Python for Android}
		...
		\begin{itemize}
			...
			\item Tribler\\
			This is a package made from the Tribler main branch\footnote{https://github.com/Tribler/tribler}. Some files are modified to make them compatible for Android.
