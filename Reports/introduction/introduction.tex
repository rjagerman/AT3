...
% Eventueel shadow internet references hier, files transporteren via smartphone ("smartphone first strategy") -> It should work in an offline environment(?)
% anontunnel naam vervangen door 

% Tor-like protocol (+and implementation) over UDP capable of ... + wat het kan doen? "discovery" 
% A complete Tor replacement in a single dispersy community.
