...
% What is tribler niet als los sub hoofdstuk
	...
	\subsection{Anonymous tunnels}
		\label{sec:anonymoustunnels}
			...
			\begin{itemize} 
				...
				\item The experimental code is using the Socks5 protocol for communication with other nodes (see figure \ref{fig:onion_encryption_decryption_socks5}). This code has been written by the Tribler team.
